...
const OCR_TEST_APP_VERSION = '1.29.0';
...
document.getElementById('captureOcrTestPhoto').addEventListener('click', () => ocrTestCameraPicker.click());

function addOcrTestFiles(fileList, source = 'gallery') {
